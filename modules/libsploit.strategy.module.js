...
function strategy_select() {
	...
	if(typeof current_device !== 'function') return false; //sanity check, in theory we should have loaded the current_device
 ...
 /*   else if(osversion_between(12.0, 12.01))
    {
        ...
        {
        	return false; //Sanity check making sure to only continue if the product name of the device was detected
        }
    ...
    */
    else if(osversion_between(12.01, 12.11))
    {
        ...
        if(supported) 
        {
            ...
            puts('Chose REGexec');
            include('libsploit.ios.1211'); //include the strategy module
            start_strategy('wk1211go'); //schedule the strategy for launch
            return true;
